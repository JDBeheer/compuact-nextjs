...
import { ArrowRight, Monitor, FileSpreadsheet, FileText, Mail, Presentation, BarChart3, FolderKanban, Bot, PenTool, Users, Laptop, BookOpen, Building2 } from 'lucide-react'
