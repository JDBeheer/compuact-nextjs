...
const categorieConfig: Record<string, {
  ...
  excel: {
    ...
    seoTitle: 'Excel Cursus Volgen? | Alle Niveaus',
    ...
    faq: [
      { vraag: 'Wat kost een cursus Excel?', antwoord: 'Een Excel cursus bij Compu Act start vanaf €275 excl. BTW. De prijs is afhankelijk van het niveau en de duur. Alle prijzen zijn all-in: inclusief laptop, cursusmateriaal, lunch en certificaat. Voor meerdere deelnemers is een incompany training vaak voordeliger (vanaf €1.295 per dag).' },
      { vraag: 'Is er een cursus Excel voor beginners?', antwoord: 'Ja, onze Excel Basis cursus is speciaal ontworpen voor beginners. In 1 dag leer je werken met formules, tabellen, grafieken en basisfuncties. Geen voorkennis vereist — alleen basiskennis van Windows. Na de cursus kun je zelfstandig werken met Excel.' },
      { vraag: 'Hoe lang duurt het om Excel te leren?', antwoord: 'Met onze klassikale cursus leer je de basis van Excel in 1 dag. Wil je gevorderde technieken leren zoals draaitabellen, formules of VBA? Dan volg je een vervolg van 1-2 dagen. In totaal kun je in 2-3 dagen van beginner naar gevorderd niveau komen.' },
      { vraag: 'Kan ik gratis Excel leren?', antwoord: 'Er zijn gratis online bronnen beschikbaar, maar deze missen de persoonlijke begeleiding en praktijkoefeningen van een klassikale cursus. Bij Compu Act werk je met een ervaren docent in een kleine groep (max 10 personen), waardoor je sneller leert en direct vragen kunt stellen. Na afloop ontvang je een erkend certificaat.' },
      { vraag: 'Welke Excel cursus past bij mij?', antwoord: 'Dat hangt af van je huidige niveau. Beginners starten met Excel Basis. Werk je al met Excel maar wil je efficiënter worden? Kies dan Excel Gevorderd of Excel Functies en Formules. Voor data-analyse zijn Excel Draaitabellen en Excel Power BI ideaal. Twijfel je? Bel ons op 023-551 3409 voor gratis advies.' },
      { vraag: 'Waar kan ik een Excel cursus volgen?', antwoord: 'Compu Act biedt Excel cursussen aan op 17 locaties door heel Nederland, waaronder Amsterdam, Rotterdam, Utrecht, Den Haag, Eindhoven en Haarlem. Je kunt de cursus ook live online volgen vanuit huis of kantoor, of als incompany training op je eigen locatie.' },
    ],
  },
  word: {
    ...
    seoTitle: 'Word Cursussen | 1- of 2-daags | Alle Niveaus',
    seoDescription: 'Word cursussen van Compu Act voor beginners en gevorderden. Klassikaal, incompany, live online of thuisstudie. Starten vanaf €275.',
  ...
  'power-bi': {
    ...
    seoTitle: 'Leer Data-analyse met Microsoft Power BI',
    seoDescription: 'Power BI cursussen van beginner tot expert. Leer data analyseren en interactieve dashboards maken. Klassikaal op 17 locaties of live online.',
  ...
  'office-365': {
    ...
    seoTitle: 'Office 365 & Microsoft Teams Cursussen',
    seoDescription: 'Office 365-training voor beginners. Kies uit Office 365 voor eindgebruikers of Microsoft Teams. Klassikaal, incompany of live online. Starten vanaf €275.',
  ...
  ai: {
    ...
    seoTitle: 'AI Cursussen | ChatGPT, Copilot & AI in Excel',
          ...
          <div className="flex flex-col lg:flex-row lg:gap-10">
            ...
            <div className="mt-8 lg:mt-0 lg:w-[300px] shrink-0">
              <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-6 lg:sticky lg:top-24">
                ...
                <LesmethodeBadges lesmethodes={cursus.inhoud?.lesmethodes || ['Klassikaal', 'Live Online', 'Thuisstudie', 'inCompany']} />
              </div>
            </div>
          </div>
        </div>
