...
const events: TrackingEvent[] = [
  ...
  },
  {
    ...
    status: 'actief',
    icon: Building2,
    toelichting: 'Stuurt ook een Google Ads conversion event met het incompany-label en pusht gform_2 naar de dataLayer.',
  },
  {
    naam: 'gform_2',
    type: 'custom',
    trigger: 'InCompany offerte-aanvraag verstuurd (samen met incompany_request)',
    ga4: false,
    googleAds: false,
    database: false,
    data: ['event: gform_2'],
    ...
    status: 'actief',
    icon: Building2,
    toelichting: 'dataLayer.push({ event: "gform_2" }) — Gravity Forms-stijl event voor GTM-triggers gekoppeld aan formulier ID 2 (incompany offerte).',
  },
  {
    naam: 'phone_click',
    type: 'custom',
